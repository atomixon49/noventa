        ...
        <Section className="relative">
          ...
          <div className="mb-12 text-center max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-slate-600 dark:text-slate-300">
              <CopyText
                ...
                defaultText={
                  lang === "de"
                    ? "Dann bist du nicht alleine. Conexio ist genau dafür gebaut."
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <div
                className={
                  "conexio-marquee conexio-marquee--left rounded-2xl " +
                  (isShowcasePaused ? "is-paused" : "")
                }
                style={{
                  // @ts-expect-error CSS var
                  "--conexio-marquee-duration": "70s",
                }}
                onClick={() => setIsShowcasePaused((v) => !v)}
              >
                <div className="conexio-marquee__track flex gap-6 pr-6">
            ...
            <div className="relative">
              ...
              <div
                className={
                  "conexio-marquee conexio-marquee--right rounded-2xl " +
                  (isShowcasePaused ? "is-paused" : "")
                }
                style={{
                  // @ts-expect-error CSS var
                  "--conexio-marquee-duration": "78s",
                }}
                onClick={() => setIsShowcasePaused((v) => !v)}
              >
                <div className="conexio-marquee__track flex gap-6 pr-6">
          ...
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white">
              <CopyText
                ...
                defaultText={lang === "de" ? "Zahlen, die erklären, warum Conexio nötig ist" : "Vertrauen von führenden Unternehmen"}
                as="span"
              />
            </h2>
          </div>
          ...
          <div className="mt-16 border-t border-slate-200 dark:border-slate-800 pt-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-400">
              ...
              <div className="flex items-center gap-6">
                ...
                <a href="https://instagram.com/conexio" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 dark:hover:text-white transition-colors flex items-center gap-1">
                ...
                <a href="https://tiktok.com/@conexio" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 dark:hover:text-white transition-colors flex items-center gap-1">
